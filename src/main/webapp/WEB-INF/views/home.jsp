     ...
     <div class="container">
       ...
       <div id="signupbox" class="mainbox col-md-5 col-md-offset-4 col-sm-7 col-sm-offset-3">
         <div class="panel panel-primary">
           ...
           <div class="panel-body" >
             <form:form method="post" action="/" modelAttribute="user"  class="form-horizontal">
               ...
               <div class="form-group">
                 ...
                 <div class="col-md-8">
                   <form:input type="text" path="firstName" class="form-control input-sm" value="${user.firstName}" placeholder="first name"/>
                 </div>
               </div>
